...
namespace TiltFive
{
    ...
    public sealed class Glasses : Singleton<Glasses>
    {
        ...
        private class GlassesCore : TrackableCore<GlassesSettings>
        {
            ...
            protected override Pose GetDefaultPoseGameboardSpace(GlassesSettings settings)
            {
                return new Pose(DEFAULT_GLASSES_POSITION_GAME_BOARD_SPACE, DEFAULT_GLASSES_ROTATION_GAME_BOARD_SPACE);
            }
