        ...
        private class WandCore : TrackableCore<WandSettings>
        {
            ...
            public new void Update(WandSettings wandSettings, ScaleSettings scaleSettings, GameBoardSettings gameBoardSettings)
            {
                ...
                fingertipsPose_UnityWorldSpace =
                    GameboardToWorldSpace(fingertipsPose_GameboardSpace, scaleSettings, gameBoardSettings);
                aimPose_UnityWorldSpace
                    = GameboardToWorldSpace(aimPose_GameboardSpace, scaleSettings, gameBoardSettings);
            }

            protected override Pose GetDefaultPoseGameboardSpace(WandSettings settings)
            {
