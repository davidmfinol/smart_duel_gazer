...
namespace AssemblyCSharp.Assets.Code.Core.General.Statics
{
    public static class AnimatorParams
    {
        ...
        public static readonly int Remove_Set_Card_Trigger = Animator.StringToHash("RemoveSetCard");
        public static readonly int Reveal_Set_Monster_Trigger = Animator.StringToHash("RevealSetMonster");
        public static readonly int Hide_Set_Monster_Image_Trigger = Animator.StringToHash("HideSetMonsterImage");
        public static readonly int Play_Monster_Attack_1_Trigger = Animator.StringToHash("Attack1");

        public static readonly int Defence_Bool = Animator.StringToHash("IsDefence");
        ...
        public static readonly int Open_Playfield_Menu_Bool = Animator.StringToHash("OpenPlayfieldMenu");
