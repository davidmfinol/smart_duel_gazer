...
namespace Code.Features.SpeedDuel.PrefabManager.ModelComponentsManager.Entities
{
    public class ModelSettings : MonoBehaviour
    {
        ...
        public static List<string> ProjectilesList = new List<string> {
            null,
            GameObjectKeys.MagicalProjectileKey,
            GameObjectKeys.BulletProjectileKey,
            GameObjectKeys.FireProjectileKey
        };
        ...
        [ProjectileListAsDropdownMenu(typeof(ModelSettings), "ProjectilesList", "Projectile Type")]
        [SerializeField] private string _projectileType;
